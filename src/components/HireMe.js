...
import { CircularText } from './Icons'// Importation du composant CircularText
    ...
    return (
       <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto sm:right-0'>
            <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
                {/* Appel du composant CircularText */}
                <CircularText  className={'fill-dark animate-spin-slow dark:fill-light'}/>
                <Link
                    href="mailto:adjeteken@gmail.com"
                    ...
                    style={{ transform: 'translate(-50%, -50%)' }} // Ajoutez cette ligne
                    >
                    Hire Me
                </Link>
            </div>
