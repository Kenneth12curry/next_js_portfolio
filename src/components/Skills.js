...
// Création d'un composant secondaire => factise
    ...
    return (
        <>
            ...
            sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
                ...
                <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light
                py-3 px-6 shadow-dark cursor-pointer absolute dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:text-xs xs:p-2'
                whileHover={{scale:1.05}}>
                    Web
                </motion.div>
                ...
                <Skill  name='C#' x='28vw' y='12vw'/>
                <Skill  name='PHP' x='0vw' y='12vw'/>
                <Skill  name='Python' x='-20vw' y='-15vw'/>
                <Skill  name='Symfony' x='15vw' y='-12vw'/>
                <Skill  name='Spring' x='32vw' y='-5vw'/>
                <Skill  name='Flask' x='0vw' y='-23vw'/>
                <Skill  name='Angular' x='-28vw' y='13vw'/>
                <Skill  name='Figma' x='-20vw' y='19vw'/>
                <Skill  name='MySQL' x='18vw' y='18vw'/>
                <Skill  name='SQLServer' x='22vw' y='-22vw'/>
            </div>
        </>
